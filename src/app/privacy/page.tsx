...
export const metadata: Metadata = {
    ...
    description: 'Privacy Policy for Rigour Labs products. Rigour CLI zero-telemetry policy. Learn how we protect your data.',
    keywords: ['privacy policy', 'data protection', 'Rigour Labs privacy', 'zero telemetry', 'GDPR compliance'],
    alternates: {
        canonical: 'https://rigour-labs.dev/privacy',
    },
    openGraph: {
        title: 'Privacy Policy | Rigour Labs',
        description: 'Privacy Policy for Rigour Labs products. Rigour CLI zero-telemetry policy.',
                ...
                <div className="container" style={{ maxWidth: '800px', margin: '0 auto' }}>
                    ...
                    <div style={{ color: 'var(--secondary)', lineHeight: '1.8' }}>
                        <section style={{ marginBottom: '2.5rem' }}>
                            ...
                            <p>
                                Rigour Labs ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our products and services, including Rigour CLI.
                            </p>
                        </section>
                        ...
                        <section style={{ marginBottom: '2.5rem' }}>
                            ...
                            <h3 style={{ color: 'white', fontSize: '1.1rem', marginBottom: '0.75rem', marginTop: '1.5rem' }}>2.2 Website Visitors</h3>
                            <p>When you visit our websites (rigour-labs.dev, rigour.run), we may collect standard web analytics data through privacy-respecting analytics tools.</p>
                        </section>
