        ...
        <section id="team" aria-labelledby="team-heading" style={{ padding: 'clamp(4rem, 8vw, 8rem) 0' }}>
            <div className="container">
                <div style={{ textAlign: 'center', marginBottom: 'clamp(4rem, 8vw, 6rem)' }}>
                    ...
                    <h2 id="team-heading" style={{ fontSize: 'clamp(2.25rem, 5vw, 3rem)', marginBottom: '1.25rem', letterSpacing: '-0.03em' }}>Engineering Team</h2>
                    <p style={{ color: 'var(--secondary)', maxWidth: '600px', margin: '0 auto', fontSize: 'clamp(1rem, 2vw, 1.125rem)', lineHeight: '1.7' }}>
                        We&apos;re systems engineers building the tools we need to trust the code and the people who write it.
                    </p>
                </div>
